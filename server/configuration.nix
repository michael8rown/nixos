...
#			securityType = "user";
			...
			settings = {
				...
				aspenshare = {
					...
					comment = "NixOS aspen Samba share";
					browseable = "yes";
					"read only" = "no";
					"guest ok" = "no";
					"create mask" = "0644";
	...
	networking.firewall.allowedTCPPorts = [ 80 443 8080 8081 systemSettings.ssh_port ];
	networking.firewall.allowedUDPPorts = [ 80 443 8080 8081 systemSettings.ssh_port ];

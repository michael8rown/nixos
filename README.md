...
What I've learned over these last couple of weeks is this: NixOS is an IT Professional's OS. It is definitely not great for beginners just wanting a normal Linux experience, and it's not even really good for Linux hobbyists like me. I really love to write new scripts in perl or python, or drum up a whole new webapp to manage some task or other in my daily life. NixOS does not seem to be well-suited for that kind of behavior.
